...
TEST(BlackBox, ReceivedDynamicDataWithNoSizeLimit)
{
    PubSubReader<HelloWorldType> reader(TEST_TOPIC_NAME);
    PubSubWriter<HelloWorldType> writer(TEST_TOPIC_NAME);
...
TEST(BlackBox, ReceivedDynamicDataWithinSizeLimit)
{
    PubSubReader<HelloWorldType> reader(TEST_TOPIC_NAME);
    PubSubWriter<HelloWorldType> writer(TEST_TOPIC_NAME);
...
TEST(BlackBox, ReceivedUserDataExceedsSizeLimit)
{
    PubSubReader<HelloWorldType> reader(TEST_TOPIC_NAME);
    PubSubWriter<HelloWorldType> writer(TEST_TOPIC_NAME);
...
TEST(BlackBox, ReceivedPartitionDataExceedsSizeLimit)
{
    PubSubReader<HelloWorldType> reader(TEST_TOPIC_NAME);
    PubSubWriter<HelloWorldType> writer(TEST_TOPIC_NAME);
...
TEST(BlackBox, ReceivedPropertiesDataWithinSizeLimit)
{
    char* value = nullptr;
...
TEST(BlackBox, ReceivedPropertiesDataExceedsSizeLimit)
{
    char* value = nullptr;
    std::string TOPIC_RANDOM_NUMBER;
    std::string W_UNICAST_PORT_RANDOM_NUMBER_STR;
